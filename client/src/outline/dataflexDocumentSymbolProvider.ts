...
export class DataFlexDocumentSymbolProvider implements vscode.DocumentSymbolProvider {
    public provideDocumentSymbols(
        ...
        const classStack: vscode.DocumentSymbol[] = []; // Stack to track nested classes
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if (endClassMatch) {
                if (classStack.length > 0) {
                    ...
                    if (completedClass) {
                        ...
                        completedClass.range = new vscode.Range(
                            completedClass.range.start,
            ...
            if (screenMatch) {
                ...
                const screenSymbol = new vscode.DocumentSymbol(
                    screenName,
                    'Screen',
                    vscode.SymbolKind.Struct,
                    new vscode.Range(new vscode.Position(i, 0), new vscode.Position(i, line.length)),
